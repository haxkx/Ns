...
class Ns_Followers:
    def __init__(self):
        ...
        self.__userid=input('[+] InstaGram UserID : ') #Enter UserID Here
        self.__username=input('[+] InstaGram UserName : ')#Enter UserName Here
        self._session=input('[+] InstaGram Session Id: ') #Enter SessionID Here
